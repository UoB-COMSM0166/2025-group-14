...
However, we recognize that in software development it is unrealistic to expect everything to go smoothly, and the ability to adapt to new challenges is an important part of the skillset. We believe that because we were able to adopt this mindset, we were therefore able to successfully carry out the refactor and ultimately deliver on our aim to create a unique, fun, and challenging game. 
